package com.common.common.util.glide;
...
import com.common.common.util.glide.video.VideoModelLoader;
import com.common.common.util.glide.video.Video;
...
public class GlideModuleConfig extends AppGlideModule {
    ...
    public void registerComponents(Context context, Glide glide, Registry registry) {
        // 注册全局唯一OkHttp客户端(Http先于Glide初始化完成的情况下)//TODO
